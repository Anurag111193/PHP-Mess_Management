...
$sql = " UPDATE storeb SET minvalue = $quantq WHERE item_name = '$itemn' ";
mysql_select_db('mess');
...
echo "
<script>
      window.location.href = 'afterlb.html';
    </script> ";
mysql_close($conn);
}
}
...
{
echo " <script>
      window.location.href = 'lberror.html';
    </script> ";
